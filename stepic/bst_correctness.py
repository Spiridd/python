class Node(object):
    def __init__(self, data, maximum, minimum, left=None, right=None):
        self.data = data
        self.left_child = left
        self.right_child = right
        self.maximum = self.data
        self.minimum = -self.data

    def insert_left(self, data):
        if self.left_child:
            self.left_child.insert_left(data, min(self.maximum, self.left_child.maximum), max(self.minimum, self.left_child.minimum))
        else:
